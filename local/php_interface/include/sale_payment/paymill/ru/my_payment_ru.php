...
$MESS["SIBP_NAME"] = "Получатель платежа";
$MESS["SIBP_INN"] = "ИНН получателя";
$MESS["SIBP_KPP"] = "КПП получателя";
$MESS["SIBP_NUMBER"] = "Номер счета получателя";
$MESS["SIBP_NAME_BANK"] = "Наименование банка";
$MESS["SIBP_REK"] = "Банковские реквизиты";
$MESS["SIBP_CALC"] = "Номер кор./сч. банка получателя";
